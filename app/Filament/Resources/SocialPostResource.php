...
use App\Filament\Resources\SocialPostResource\Pages\CreateSocialPost;
...
class SocialPostResource extends Resource
{
    ...
    {
        return Post::where('created_at', '>=', now()->subDays(7))->count();
    }
        ...
        return $table
            ...
            ->filters([
                Filter::make('published')
                    ->query(fn ($query) => $query->whereNotNull('created_at')),
