<header x-data="{ open: false }" class="bg-white/80 dark:bg-gray-900/80 border-b border-gray-200/80 dark:border-gray-200/[15%] backdrop-blur-sm">
    ...
    <div class="px-4 mx-auto max-w-7xl sm:px-6 lg:px-8">
        <div class="flex justify-between h-16">
            <!-- Logo -->
            <a href="{{ route('filament.admin.pages.dashboard') }}" class="flex items-center shrink-0">
                ...
                <div class="flex items-center">
                    ...
                    @auth
                        ...
                        >
                            ...
                            <div x-show="dropdownOpen" @click.away="dropdownOpen=false" class="absolute top-0 right-0 z-50 w-full mt-16 sm:mt-12 sm:origin-top-right sm:w-40" x-cloak>
