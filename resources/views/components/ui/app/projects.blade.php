<div class="max-w-7xl mx-auto p-8 bg-gradient-to-br from-gray-100 to-gray-300 dark:from-gray-900 dark:to-gray-800 rounded-3xl shadow-2xl">
    <!-- Header Section -->
    <div class="text-center mb-12">
        <a href="https://www.mycareeradvisor.com/" target="_blank" class="text-teal-600 dark:text-teal-400">
            <div class="relative w-full bg-white rounded-3xl p-6 overflow-hidden cursor-pointer hover:bg-gray-50 dark:hover:bg-gray-600 transition-all shadow-md">
                <img src="https://www.mycareeradvisor.com/img/mca-logo-wide-orange.png" alt="My Career Advisor" class="w-full h-auto rounded-3xl transition-transform transform hover:scale-110">
                <div class="absolute inset-0 bg-black bg-opacity-30 flex items-center justify-center opacity-0 hover:opacity-100 transition-opacity">
                    <span class="text-white text-2xl font-extrabold">Visit</span>
                </div>
            </div>
        </a>
    </div>
    ...
    <div class="grid grid-cols-1 lg:grid-cols-2 gap-12">
        <!-- Visual Frame -->
        <div class="relative w-full h-[640px] bg-white dark:bg-gray-700 rounded-3xl overflow-hidden shadow-2xl transition-transform transform hover:scale-105">
            <iframe id="my-iframe" src="https://www.mycareeradvisor.com" class="absolute top-0 bottom-0 left-0 right-0 w-full h-full rounded-3xl border-none"></iframe>
        </div>
