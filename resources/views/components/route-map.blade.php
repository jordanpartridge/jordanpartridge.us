<div class="relative w-full lg:w-1/3 mb-4 lg:mb-0 lg:mr-6">
    <div
        class="bg-gray-100 dark:bg-gray-800 rounded-lg overflow-hidden w-full h-64 lg:h-full shadow-lg transition-transform duration-300 transform hover:scale-105">
