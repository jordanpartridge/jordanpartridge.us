<div class="bg-white dark:bg-gray-800 bg-opacity-80 dark:bg-opacity-30 rounded-lg p-6 shadow-lg backdrop-filter backdrop-blur-lg border border-gray-200 dark:border-gray-700 hover:shadow-primary-500/50 dark:hover:shadow-secondary-500/50 transition duration-300 transform hover:-translate-y-1">
    <div class="flex items-start justify-between mb-3">
        <div class="flex items-center">
            ...
            <h3 class="text-xl font-semibold text-gray-800 dark:text-gray-200">{{ $name }}</h3>
        </div>
    ...
    <div class="flex justify-between items-center mt-auto">
        ...
        <a href="{{ $url }}" target="_blank" rel="noopener noreferrer" class="inline-flex items-center text-primary-600 dark:text-primary-400 hover:text-primary-800 dark:hover:text-primary-300 transition-colors">
            View Repository
