...
\Livewire\Volt\mount(function () {
    $this->rides              = \App\Models\Ride::whereDate('date', '>', now()->subWeek());
        ...
        <div class="flex items-center w-full max-w-6xl px-8 pt-12 pb-20 mx-auto">
            <div class="container relative max-w-4xl mx-auto mt-20 text-center sm:mt-24 lg:mt-32">
                ...
                <div id="dashboard" class="bg-white dark:bg-gray-800 rounded-lg shadow-lg p-6 mt-8">
                    <h2 class="text-xl font-semibold text-gray-800 dark:text-white mb-4 text-center">Weekly
                        Statistics</h2>
                    <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
                        <div class="item bg-white dark:bg-gray-700 rounded-lg p-6 shadow">
                            <h2 class="text-xl font-semibold text-gray-800 dark:text-white mb-4"> Mileage</h2>
                            <p class="text-lg text-gray-600 dark:text-gray-300">{{ number_format($this->weeklyMileage, 1) }}
                                miles</p>
                        </div>
                        <div class="item bg-white dark:bg-gray-700 rounded-lg p-6 shadow">
                            <h2 class="text-xl font-semibold text-gray-800 dark:text-white mb-4">Average Speed Per Ride
                                Speed</h2>
                            <p class="text-lg text-gray-600 dark:text-gray-300">{{ number_format($this->weeklyAverageSpeed, 1) }}
                                mph</p>
                        </div>
                        <div class="item bg-white dark:bg-gray-700 rounded-lg p-6 shadow">
                            <h2 class="text-xl font-semibold text-gray-800 dark:text-white mb-4">Average Max Speed Per Ride</h2>
                ...
                <div class="bg-white dark:bg-gray-800">
                    <div class="max-w-7xl mx-auto py-8 px-4 sm:px-6 lg:px-8">
                        ...
                        <div class="shadow-lg rounded-lg overflow-hidden">
                            <iframe
                                src="https://www.strava.com/athletes/2645359/activity-summary/6ca39d65357fcc443b84609f5797366fb5c811cd"
