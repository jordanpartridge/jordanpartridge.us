    ...
    <div class="pb-5">
        <div class="mx-auto space-y-6">
            ...
            <section
                ...
                <div class="max-w-xl">
                    <header>
                        <h2 class="text-lg font-medium text-gray-900 dark:text-gray-100">{{ __('Strava Integration') }}</h2>
                        <p class="mt-1 text-sm text-gray-600 dark:text-gray-400">{{ __('Connect your Strava account to import your activities and stats.') }}</p>
                    </header>
