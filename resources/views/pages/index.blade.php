    ...
    <div class="relative flex flex-col items-center justify-center w-full h-auto overflow-hidden" x-cloak>
        ...
        <div class="flex items-center w-full max-w-6xl px-8 pt-8 pb-16 mx-auto text-white">
            <div class="container relative max-w-4xl mx-auto mt-12 text-center space-y-6">
                ...
                <div class="relative inline-block w-auto p-1 shadow-lg rounded-full overflow-hidden group">
                    <div
                        class="absolute inset-0 bg-gradient-to-r from-purple-600 via-blue-500 to-green-400 opacity-75 transition duration-500 ease-in-out group-hover:opacity-0"></div>
                    <div
                        class="absolute inset-0 bg-gradient-to-r from-red-500 via-yellow-500 to-pink-500 opacity-0 transition duration-500 ease-in-out group-hover:opacity-75"></div>
                    <p class="relative z-10 w-auto h-full px-6 py-2 bg-slate-50 dark:bg-neutral-900 dark:text-white font-semibold text-md tracking-wide uppercase rounded-full text-slate-800/90 group-hover:text-white transition duration-300">
                        Jordan Partridge
                    </p>
                    <div
                        class="absolute inset-0 flex items-center justify-center bg-gradient-to-r from-purple-600 via-blue-500 to-green-400 opacity-0 group-hover:opacity-100 transition duration-500 ease-in-out">
                ...
                <h1 class="mt-5 text-4xl font-extrabold leading-tight tracking-tight text-center dark:text-white text-slate-800 sm:text-5xl md:text-6xl">
                    Passionate Software Engineer
                </h1>

                <p class="w-full max-w-2xl mx-auto mt-6 text-lg dark:text-white/60 text-slate-900">
                ...
                <p class="w-full max-w-2xl mx-auto mt-4 text-lg dark:text-white/60 text-slate-900">
