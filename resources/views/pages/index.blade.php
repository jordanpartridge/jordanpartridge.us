...
<x-layouts.marketing>
    ...
    <img src="/img/logo.jpg" alt="logo" class="rounded-full" width="128" height="128">
                    ...
                    <div style="background-image:linear-gradient(160deg,#e66735,#e335e2 50%,#73f7f8, #a729ed)" class="inline-block w-auto p-0.5 shadow rounded-full animate-gradient">
                        <p class="w-auto h-full px-3 bg-slate-50 dark:bg-neutral-900 dark:text-white py-1.5 font-medium text-sm tracking-widest uppercase  rounded-full text-slate-800/90 group-hover:text-white/100">Jordan Partridge</p>
                    </div>
                    <h1 class="mt-5 text-4xl font-light leading-tight tracking-tight text-center dark:text-white text-slate-800 sm:text-5xl md:text-8xl">Passionate Software Engineer</h1>
                    <p class="w-full max-w-2xl mx-auto mt-8 text-lg dark:text-white/60 text-slate-500">Software Engineer | Foodie | Fat bike Fattie</p>
                    <div class="flex items-center justify-center w-full max-w-sm px-5 mx-auto mt-8 space-x-5">
                        <x-ui.button type="secondary" tag="a" href="https://www.linkedin.com/in/jordan-partridge-8284897/" target="_blank">Linkedin</x-ui.button>
                        <x-ui.button type="primary" tag="a" href="https://github.com/jordanpartridge" target="_blank">View Github</x-ui.button>
                    </div>
                </div>
            </div>
