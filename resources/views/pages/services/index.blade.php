        ...
        <div class="container mx-auto px-4 py-16">
            ...
            <div class="mb-16 text-center">
                ...
                <p class="max-w-3xl mx-auto text-lg text-gray-600 dark:text-gray-300 mb-8">
                    Veteran of both military and digital battlefields, I bring precision, adaptability, and strategic thinking to every Laravel project. As your Laravel Marksman, I deliver battle-tested solutions that hit the target every time.
                </p>
                    ...
                    <div class="bg-white dark:bg-gray-800 bg-opacity-80 dark:bg-opacity-30 rounded-lg p-8 shadow-2xl backdrop-filter backdrop-blur-lg border border-gray-200 dark:border-gray-700 relative overflow-hidden group hover:shadow-blue-500/50 dark:hover:shadow-blue-500/30 transition-all duration-300">
                        ...
                        <div class="relative z-10">
                            ...
                            <p class="text-gray-600 dark:text-gray-300 mb-6">
                                Comprehensive assessment of your codebase to identify vulnerabilities, performance bottlenecks, and opportunities for optimization. Like military reconnaissance, I'll map out your terrain and identify potential threats.
                            </p>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
                            ...
                            <div class="bg-white dark:bg-gray-800 p-6 rounded-lg shadow-md border border-gray-100 dark:border-gray-700">
                                ...
                                <p class="text-gray-600 dark:text-gray-300 italic">
                                    "Jordan's military background truly shines through in his work. The precision and attention to detail in his code is remarkable. Our Laravel application performance improved by 40% after his optimization work."
                                </p>
                            </div>
            ...
            <div class="text-center">
                ...
                <p class="max-w-3xl mx-auto text-lg text-gray-600 dark:text-gray-300 mb-8">
                    Let's discuss how my Laravel engineering and consulting services can help you achieve your objectives with military precision and efficiency.
                </p>
